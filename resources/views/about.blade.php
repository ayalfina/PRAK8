                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-10 mx-auto">
                            <div class="bg-faded rounded p-5">
                                ...
                                <p>Website ini adalah website untuk admin atau petugas dalam mengatur inventaris barang dalam perusahaan, admin atau petugas dapat melihat list product yang tersedia
                                    serta menambah, mengedit, menghapus barang. 
                                </p>
                                <p class="mb-0">
                                    
                                    <em>Product</em>
                                    Product yang dijual dan ada di dalam inventaris adalah film kamera dan beberapa atribut pelengkap nya.
                                </p>
                            </div>
                        </div>
                    </div>
